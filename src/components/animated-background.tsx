...
const AnimatedBackground = () => {
  ...
  const createSectionTimeline = (
    ...
    gsap.timeline({
      scrollTrigger: {
        ...
        scrub: true,
        onEnter: () => setActiveSection(targetSection),
        onLeaveBack: () => setActiveSection(prevSection),
      },
    });
  };
  ...
  const setupScrollAnimations = () => {
    ...
    // Fade out the entire 3D scene when scrolling out of the hero section
    gsap.timeline({
      scrollTrigger: {
        trigger: "#skills",
        start: "top bottom",
    ...
    }).to(splineContainer.current, {
      autoAlpha: 0,
    });

    // Section transitions (for updating activeSection state)
