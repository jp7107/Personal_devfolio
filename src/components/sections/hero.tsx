      ...
      <div className="grid md:grid-cols-2">
          ...
          {!isLoading && (
            <div className="flex flex-col">
              ...
              <div className="mt-8 flex flex-col gap-3 w-fit">
                <Link
                  href={
                    "https://drive.google.com/file/d/1HM82-wn_mlToRK1J24Yb9HdqgmnFVsf1/view?usp=sharing"
                  }
                  target="_blank"
                  className="flex-1"
                >
        ...
        <div className="grid col-span-1 items-center justify-center">
          ...
          <div className="relative animate-fade-in animation-delay-300 flex items-center justify-center">
            {/* Profile Image with 3D animated border */}
            <div className="relative max-w-[14rem] md:max-w-[18rem] mx-auto mt-10 md:mt-0">
              {/* Outer glow layer */}
              <div className="absolute -inset-3 rounded-3xl bg-gradient-to-br from-cyan-400/20 via-violet-500/20 to-pink-400/20 blur-2xl" />

              {/* Animated conic-gradient spinning border card */}
              ...
              <div className="absolute -bottom-5 -right-5 glass rounded-xl px-4 py-3 animate-float z-10 shadow-lg shadow-cyan-500/10">
